[ { assignee: { data: 'fs', annotation: '' },
  ...
  { assignee: { data: 'CoffeeScript', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'Repl', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'nopt', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  ...
  { assignee: { data: 'escodegen', annotation: '' },
    expression: 
     { body: [Object],
       ...
       catchBody: null,
       finallyBody: null } },
  { assignee: { data: 'esmangle', annotation: '' },
    expression: 
     { body: [Object],
       catchAssignee: null,
       catchBody: null,
       finallyBody: null } },
  { assignee: { data: 'inspect', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'knownOpts', annotation: '' },
    expression: { members: [] } },
  { assignee: { data: 'option', annotation: '' },
    expression: { parameters: [], body: [Object] } },
  { assignee: { data: 'parameter', annotation: '' },
    expression: { parameters: [], body: [Object] } },
  { assignee: { data: 'optAliases', annotation: '' },
    expression: { members: [Object] } },
  { function: { data: 'option', annotation: '' },
    arguments: 
     [ [Object],
       [Object],
       [Object],
       ...
       [Object],
       [Object] ] },
  { function: { data: 'parameter', annotation: '' },
  ...
  { condition: { expression: [Object] },
    consequent: { statements: [Object] },
    alternate: null },
  { assignee: { data: 'options', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'positionalArgs', annotation: '' },
    expression: { expression: [Object], memberName: 'remain', raw: NaN } },
  { expression: { expression: [Object], memberName: 'argv', raw: NaN } },
  { op: 'ExistsOp',
    assignee: { expression: [Object], memberName: 'optimise', raw: NaN },
    expression: { data: true } },
  { assignee: { expression: [Object], memberName: 'sourceMap', raw: NaN },
    expression: { expression: [Object], indexingExpr: [Object], raw: NaN } },
  { assignee: { expression: [Object], memberName: 'sourceMapFile', raw: NaN },
    expression: { expression: [Object], indexingExpr: [Object], raw: NaN } },
  { condition: { expression: [Object], generated: true },
    consequent: { statements: [Object] },
    alternate: null },
  { condition: { left: [Object], right: [Object] },
    consequent: { statements: [Object] },
    alternate: null },
  { condition: { left: [Object], right: [Object] },
    consequent: { statements: [Object] },
  ...
  { condition: { left: [Object], right: [Object] },
    consequent: { statements: [Object] },
    alternate: null },
  { assignee: { data: 'output', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { condition: { expression: [Object], memberName: 'help', raw: NaN },
    consequent: { statements: [Object] },
    alternate: 
     { condition: [Object],
       consequent: [Object],
