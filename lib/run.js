[ { assignee: { data: 'path', annotation: '' },
  ...
  { assignee: { data: 'Module', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'CoffeeScript', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { members: [Object] },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'patched', annotation: '' },
    expression: { data: false } },
  { assignee: { data: 'patchStackTrace', annotation: '' },
    expression: { parameters: [], body: [Object] } },
  { assignee: { data: 'formatSourcePosition', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'runMain', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'runModule', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
