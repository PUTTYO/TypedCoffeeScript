module.exports = (function(){
  ...
  var result = {
    ...
    parse: function(input) {
      ...
      function parse_TypeClass() {
        var cacheKey = "TypeClass@" + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_TypeAnnotation() {
        ...
        if (r0 !== null) {
          reportedPos = r1;
          r0 = (function(cls) {return {annotation:cls};})(r5);
        }
        if (r0 === null) {
          pos = r1;
        }
      ...
      function parse_Assignable() {
        ...
        r1 = pos;
        r2 = pos;
        r3 = parse_memberAccess();
        if (r3 !== null) {
          r4 = parse__();
          if (r4 !== null) {
            r5 = parse_TypeAnnotation();
            r5 = r5 !== null ? r5 : "";
            if (r5 !== null) {
              r0 = [r3, r4, r5];
            } else {
