...
(function() {
  var CoffeeScript, Compiler, Nodes, Optimiser, Parser, Preprocessor, cscodegen, decide_expr_type, escodegen, escodegenFormat, formatParserError, pkg, typecheck, _ref;
  ...
  typecheck = function(cs_ast) {
    var assignee, expression, scope, _i, _len, _ref, _ref1;
    scope = {};
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (assignee.annotation.annotation.toLowerCase() !== decide_expr_type(expression)) {
