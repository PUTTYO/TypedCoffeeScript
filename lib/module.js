...
(function() {
  var CoffeeScript, Compiler, Nodes, Optimiser, Parser, Preprocessor, ScopeNode, console, cscodegen, escodegen, escodegenFormat, formatParserError, guess_expr_type, pkg, typecheck, _ref, _typecheck;
  ...
  _typecheck = function(statements, scope) {
    ...
    for (_i = 0, _len = statements.length; _i < _len; _i++) {
      ...
      if ((statement.nameAssignee != null) && (statement.body != null)) {
