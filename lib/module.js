[ { assignee: { members: [Object] },
  ...
  { assignee: { data: 'scope', annotation: '' },
    expression: { members: [] } },
...
var CoffeeScript, Compiler, cscodegen, escodegen, escodegenFormat, formatParserError, guess_expr_type, Nodes, Optimiser, Parser, pkg, Preprocessor, scope, typecheck;
...
typecheck = function (cs_ast) {
  var assigned_type, assignee, cache$, expression, infered_type, registered_type;
