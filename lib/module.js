[ { assignee: { members: [Object] },
  ...
  { assignee: { data: 'decide_expr_type', annotation: '' },
...
var CoffeeScript, Compiler, cscodegen, decide_expr_type, escodegen, escodegenFormat, formatParserError, Nodes, Optimiser, Parser, pkg, Preprocessor, scope, typecheck;
...
typecheck = function (cs_ast) {
  return console.log(cs_ast.body.statements);
};
CoffeeScript = {
