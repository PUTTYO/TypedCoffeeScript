[ { assignee: { members: [Object] },
  ...
  { assignee: { data: 'CS', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { expression: {}, memberName: 'numberLines' },
    expression: { assignee: [Object], expression: [Object] } },
  { assignee: { data: 'cleanMarkers', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { expression: {}, memberName: 'humanReadable' },
    expression: { assignee: [Object], expression: [Object] } },
  { assignee: { expression: {}, memberName: 'formatParserError' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { expression: {}, memberName: 'pointToErrorLocation' },
    expression: { assignee: [Object], expression: [Object] } },
  { assignee: { expression: {}, memberName: 'beingDeclared' },
    expression: { assignee: [Object], expression: [Object] } },
  { assignee: { expression: {}, memberName: 'declarationsFor' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'usedAsExpression_', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { expression: {}, memberName: 'usedAsExpression' },
    expression: { assignee: [Object], expression: [Object] } },
  { assignee: { data: 'envEnrichments_', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { expression: {}, memberName: 'envEnrichments' },
    expression: { assignee: [Object], expression: [Object] } } ]
