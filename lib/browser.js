[ { assignee: { expression: [Object], memberName: 'exports', raw: NaN },
  ...
  { assignee: { expression: [Object], memberName: 'eval', raw: NaN },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { expression: [Object], memberName: 'run', raw: NaN },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { expression: [Object], memberName: 'load', raw: NaN },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'runScripts', annotation: '' },
    expression: { parameters: [], body: [Object] } },
  { condition: { expression: [Object] },
    consequent: { statements: [Object] },
    alternate: { condition: [Object], consequent: [Object], alternate: null } } ]
