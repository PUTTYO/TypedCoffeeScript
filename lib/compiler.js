[ { assignee: { members: [Object] },
  ...
  { assignee: { members: [Object] },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'CS', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'JS', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'exports', annotation: '' },
    expression: { left: [Object], right: {} } },
  { assignee: { data: 'jsReserved', annotation: '' },
    expression: { members: [Object] } },
  { assignee: { data: 'genSym', annotation: '' },
    expression: { expression: [Object] } },
  { assignee: { data: 'stmt', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'expr', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'makeReturn', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'generateMutatingWalker', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'declarationsNeeded', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'declarationsNeededRecursive', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'collectIdentifiers', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'needsCaching', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'forceBlock', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'makeVarDeclaration', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'isIdentifierName', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'memberAccess', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'dynamicMemberAccess', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'assignment', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'hasSoak', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'generateSoak', annotation: '' },
    expression: { expression: [Object] } },
  { assignee: { data: 'helperNames', annotation: '' },
    expression: { members: [] } },
  { assignee: { data: 'helpers', annotation: '' },
    expression: { members: [Object] } },
  { assignee: { data: 'enabledHelpers', annotation: '' },
    expression: { members: [] } },
  { isOwn: true,
    keyAssignee: { data: 'h', annotation: '' },
    valAssignee: { data: 'fn', annotation: '' },
    target: { data: 'helpers', annotation: '' },
    filter: null,
    body: { statements: [Object] } },
  { assignee: { data: 'inlineHelpers', annotation: '' },
    expression: { members: [Object] } },
  { isOwn: true,
    keyAssignee: { data: 'h', annotation: '' },
    valAssignee: { data: 'fn', annotation: '' },
    target: { data: 'inlineHelpers', annotation: '' },
    filter: null,
    body: { statements: [Object] } },
  { nameAssignee: { expression: [Object], memberName: 'Compiler', raw: NaN },
    parent: null,
