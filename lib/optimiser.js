[ { assignee: { members: [Object] },
  ...
  { assignee: { data: 'makeDispatcher', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { data: 'isTruthy', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'isFalsey', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { assignee: { data: 'mayHaveSideEffects', annotation: '' },
    expression: { function: [Object], arguments: [Object] } },
  { nameAssignee: { expression: [Object], memberName: 'Optimiser', raw: NaN },
    parent: null,
