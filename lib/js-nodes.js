[ { assignee: { members: [Object] },
  ...
  { assignee: { data: 'createNode', annotation: '' },
    expression: { parameters: [Object], body: [Object] } },
  { assignee: { expression: {}, memberName: 'Nodes' },
    expression: 
     { nameAssignee: [Object],
       parent: null,
       ctor: null,
       ...
       boundMembers: [],
       name: [Object] } },
  { assignee: { data: 'nodeData', annotation: '' },
    expression: { members: [Object] } },
  { valAssignee: { members: [Object] },
    keyAssignee: null,
    target: { data: 'nodeData', annotation: '' },
    step: { data: 1, raw: '1', generated: true },
    filter: null,
